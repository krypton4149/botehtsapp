...
function menuSection(R, menuDb) {
  ...
  if (menuDb == null) {
    ...
    noteHtml = `<div class="menuNote">
          This list is loaded from your <b>Supabase</b> tables <code>menu_categories</code> and <code>menu_items</code>. The WhatsApp bot reads the same data (cached ~60s). <code>R.menu</code> in <code>server.js</code> is only used if the database has no active items.
        </div>`;
